...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var app, PORT, db, graphqlServer, httpServer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, mongo_1.connect()];
                case 1:
                    db = _a.sent();
                    graphqlServer = server_1.default(db);
...
run().then(function () { return console.log("Server Successfully Started"); });
